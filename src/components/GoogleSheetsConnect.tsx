...
export function GoogleSheetsConnect() {
  ...
  const exchangeCodeForTokens = useCallback(async (code: string) => {
    ...
    try {
        ...
        // Let the Supabase function handle the token exchange
        console.log('🔄 [exchangeCodeForTokens] Sending code to save-google-token function');
        
        // Send only the code and monday_user_id to our backend
