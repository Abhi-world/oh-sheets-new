        ...
        <div className="mb-8">
          <div className="flex justify-between items-center mb-4">
            ...
            <Button
              ...
              className="text-white hover:bg-navy-light border-b border-google-green"
            >
          ...
          {(!mondayConnected || !sheetsConnected) && (
            <div className="bg-navy-light backdrop-blur-sm rounded-lg p-4 mt-4 border-t-2 border-google-green shadow-lg">
